...
export default function HoursBreakdown({ startTime, endTime, skipDeduction = false }) {
  ...
  const result = computeHoursBreakdown(startTime, endTime, rule.tiers, skipDeduction)
